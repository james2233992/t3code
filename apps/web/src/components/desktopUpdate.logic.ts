...
export const DESKTOP_RELEASE_TAG_URL = `${PRODUCT_REPOSITORY_URL}/releases/tag`;
...
export function getDesktopUpdateInstallConfirmationMessage(
  ...
  const windowsInstallWarning = isWindowsPlatform(platform)
    ? `\n\nOn Windows, ${PRODUCT_BASE_NAME} may remain closed for several minutes while the update installs, and no installer window may appear. ${PRODUCT_BASE_NAME} will reopen automatically when installation finishes.`
    : "";
