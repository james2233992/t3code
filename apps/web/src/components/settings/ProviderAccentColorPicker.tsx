    ...
    <div className="w-56 bg-popover">
      ...
      <div className="grid gap-3 p-3">
        ...
        <input
          ...
          aria-label="Color de acento hexadecimal personalizado"
          spellCheck={false}
        />
      </div>
    </div>
      ...
      <PopoverTrigger
        render={
          <button
            ...
            aria-label={`Elegir color de acento personalizado para ${props.displayName}`}
          >
    ...
    <div className="grid gap-2">
      ...
      <div className="flex min-w-0 flex-wrap items-center gap-2">
        ...
        <Button
          ...
          aria-label={`Quitar color de acento de ${displayName}`}
