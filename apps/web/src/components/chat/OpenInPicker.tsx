...
export const OpenInPicker = memo(function OpenInPicker({
  ...
  return (
    <Group aria-label="Abrir en el editor">
      <Button
        aria-label={compact ? "Abrir archivo en el editor preferido" : undefined}
        className="ps-[8.5px]"
        size="xs"
        variant="outline"
      ...
      <Menu>
        ...
        <MenuPopup align="end">
          {options.length === 0 && (
            <MenuItem disabled>No se encontraron editores instalados</MenuItem>
          )}
