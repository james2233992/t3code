...
describe("isLegalDocumentUrl", () => {
  it.each([
    "https://iaonline.io/legal",
    "https://iaonline.io/legal/",
    "https://iaonline.io/privacy-policy?source=app",
    "https://iaonline.io/terms-of-service#updates",
    "https://iaonline.io/security-policy",
  ])("allows a configured legal document: %s", (url) => {
    expect(isLegalDocumentUrl(url)).toBe(true);
  });

  it.each([
    "https://iaonline.io/download",
