...
interface CloudEnvironmentRowsProps {
  ...
  /**
   * Hide the "Fenix Connect" section title + refresh button for hosts that
...
/**
 * "Fenix Connect" section: every environment published to the signed-in account,
 * with connect switches, availability status, refresh, and loading/error
 * states. Shared between the Settings environments screen and the Fenix Connect
 * onboarding sheet.
 *
