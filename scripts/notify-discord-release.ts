  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Fenix Code prerelease is available for nightly testers."
          : "A new Fenix Code latest release is available.",
...
).pipe(Command.withDescription("Post a Fenix Code release announcement to Discord."));
