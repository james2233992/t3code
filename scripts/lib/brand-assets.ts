export const BRAND_ASSET_PATHS = {
  ...
  productionWebFaviconIco: "assets/prod/fenix-web-favicon.ico",
  productionWebFavicon16Png: "assets/prod/fenix-web-favicon-16x16.png",
  productionWebFavicon32Png: "assets/prod/fenix-web-favicon-32x32.png",
  productionWebAppleTouchIconPng: "assets/prod/fenix-web-apple-touch-180.png",
  ...
  developmentWebFaviconIco: "assets/prod/fenix-web-favicon.ico",
  developmentWebFavicon16Png: "assets/prod/fenix-web-favicon-16x16.png",
  developmentWebFavicon32Png: "assets/prod/fenix-web-favicon-32x32.png",
  developmentWebAppleTouchIconPng: "assets/prod/fenix-web-apple-touch-180.png",
} as const;
